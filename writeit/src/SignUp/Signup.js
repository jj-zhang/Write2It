...
class SignUp extends React.Component {
    ...
    signup = e =>{
        ...
        // API CALL, Sending the data to the server
        const signup_success=true;
        if (signup_success){
    ...
    render() {
        return (
                <div id="signup">
                    <form id="signupform" className="ui form" onSubmit={this.signup}>
                        <div id="profileIconContainer" className="field">
                        ...
                        <div id="profileInputContainer">
                            ...
                            <div className="field">
                                <label>Email</label>
                                <div className="ui left icon input">
                                    <input type="text" name="email"  placeholder="XXXX@gmail.come" required/>
